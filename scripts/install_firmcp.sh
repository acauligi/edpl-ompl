...
sudo apt install git cmake libeigen3-dev mercurial 
	...
	git checkout origin/1.3.1	# d0511
      ...
      cd .. # acauligi
				# install_common_dependencies()
					sudo apt-get install libboost-all-dev libflann-dev
            ...
            wget https://data.kitware.com/api/v1/file/5877a2498d777f05f44b13fb/download/castxml-linux.tar.gz   # acauligi
						sudo apt-get install stow	# in case you don't have this
...
# install other dependencies
	sudo apt-get install freeglut3-dev libqt4-dev libtinyxml-dev
